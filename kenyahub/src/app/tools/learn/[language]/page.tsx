...
// Course data imports — add new languages here
...
> = {
  ...
  // kikuyu: { config: KIKUYU_CONFIG, units: KIKUYU_UNITS },
  // swahili: { config: SWAHILI_CONFIG, units: SWAHILI_UNITS },
};

// Get the Tool object from the registry
...
/* ═══════════════════════════════════════════════════════
   ...
   Skill tree + lesson player + games for a specific language
   ═══════════════════════════════════════════════════════ */

export default function LanguagePage() {
  const params = useParams();
  const languageId = typeof params.language === "string" ? params.language : "";
  ...
  // Quit lesson (go back to skill tree)
  ...
  return (
    <ToolShell tool={LEARN_TOOL}>
      ...
      {/* Tab bar (only when NOT in a lesson) */}
      {view !== "playing" && (
